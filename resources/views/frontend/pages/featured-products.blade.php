...
{{-- Sets the content for the 'title' section with the value 'Featured Products'. --}}
...
<div class="py-5">
    <div class="container">
        <div class="row">
            ...
            {{-- Loop through the $featuredProducts collection to display each product item. --}}
            ...
            {{-- If there are no featured products available, display a message. --}}
            @empty
            ...
            {{-- Button to shop more products in the collections. --}}
